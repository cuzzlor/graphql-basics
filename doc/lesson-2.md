...
> You do not need to interpolate and escape parameter values into the `query` string. Instead, bind parameters using `$paramName` syntax and supply a `variables` map.
